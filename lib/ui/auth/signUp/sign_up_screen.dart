...
import 'package:todark/ui/auth/signUp/sign_up_bloc.dart';
import 'package:todark/ui/auth/welcome/welcome_screen.dart';
import 'package:todark/ui/home/home_screen.dart';
                ...
                listener: (context, state) {
                  ...
                  if (state.authState == AuthState.authenticated) {
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                        builder: (context) =>
                            WelcomeScreen(), // Ganti dengan nama layar sambutan Anda
                      ),
                      (route) => false,
                    );
                  } else {
